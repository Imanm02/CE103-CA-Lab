...
\newcommand{\so}{\xRightarrow[]{}}
\newcommand{\sotext}[1]{\xRightarrow[]{\text{#1}}}
\newcommand{\zigma}[3]{\mathlarger{\sum}_{#1=#2}^{#3}}
\newcommand{\bigpi}[3]{\mathlarger{\prod}_{#1=#2}^{#3}}
\newcommand{\zigpi}[2]{\mathlarger{\sum}_{#1\in#2}}
\newcommand{\integral}[3]{\mathlarger{\int}_{#1}^{#2}{#3}}
\newcommand{\integralx}[1]{\mathlarger{\int}{#1}}
\newcommand{\Lim}[2]{\mathlarger{\lim_{#1 \to #2}}}
...
{‌
	%\ifsolution\hrule\vspace{.3cm}\fi\noindent
	\ifsolution\hrule\vspace{-.45cm}\else\hrule\fi
	\vspace{0.65cm}
}
...
\newcommand{\header}[2]{
	...
	\begin{figure}[H]
		...
		\iflogo
		\put (13.125, -1.75) {
			\makecell{\includegraphics[width=0.17\textwidth]{figures/logo}\\ }
		}
		\else
		\put (12.9, -3.1) {
